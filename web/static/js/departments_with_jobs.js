var departments_with_jobs = {
  ...
  "Hair And Makeup": [
    ...
    "Hair Designer",
    "Hairdresser",
    "Junior Hair and Make Up Artist",
  ...
  "Production": [
    ...
    "Associate Producer (PAYE)",
    "Associate Producer (Sch D)",
    "Cast Assistant",
    "Co-Producer",
    "Digital Archivist",
    ...
    "Rushes Runner",
    "Script Supervisor",
    "Shipping and Accommodation Coordinator",
    "Travel Assistant",
    "Travel Coordinator",
    "Travel Manager",
...
export default departments_with_jobs;
