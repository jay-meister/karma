defmodule Engine.Formatter do
  ...
  def format_offer_data(offer_data) do
    ...
    offer_data = %{
      ...
      "sixth_day_holiday_pay": "#{currency_symbol} #{format_number(offer_data.sixth_holiday_pay)}",
      ...
      "seventh_day_holiday_pay": "#{currency_symbol} #{format_number(offer_data.seventh_holiday_pay)}",
