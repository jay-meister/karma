defmodule Karma.Controllers.HelpersTest do
  ...
  test "determine_contract_type(department, job_title) Transport" do
    sch_d_contract = Helpers.determine_contract_type("Transport", "Transport Captain")
    paye_contract = Helpers.determine_contract_type("Transport", "Transport Coordinator")
    conditional_contract = Helpers.determine_contract_type("Transport", "Unit Driver")
